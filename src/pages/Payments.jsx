  ...
  return (
    <div className="bg-[#23232b] dark:bg-[#23232b] rounded-2xl shadow-lg p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-gray-100">Payments</h2>
        <Button variant="contained" color="primary" onClick={() => handleOpen()}>Add Payment</Button>
      </div>
      <Table>
        <TableHead>
          <TableRow>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>{form.id ? 'Edit Payment' : 'Add Payment'}</DialogTitle>
        <DialogContent>
