...
export const TABLE_COLUMN_CONFIGS = {
  orders: [
    ...
    { key: 'status', label: 'Status Order', sortable: true, defaultVisible: true, align: 'left' },
    ...
    { key: 'totalHarga', label: 'Total Harga', sortable: true, defaultVisible: true, align: 'right' },
  ...
  payments: [
    ...
    { key: 'method', label: 'Metode', sortable: true, defaultVisible: true, align: 'left' },
