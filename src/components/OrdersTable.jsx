    ...
    <Table>
      <TableHead>
        <TableRow sx={{ bgcolor: 'transparent' }}>
          ...
          <TableCell sx={{ color: 'var(--text)', fontWeight: 700 }}>Phone</TableCell>
          <TableCell sx={{ color: 'var(--muted)', fontWeight: 700 }}>Tanggal Order</TableCell>
          <TableCell sx={{ color: 'var(--accent-2)', fontWeight: 700 }}>Status Urgensi</TableCell>
          <TableCell sx={{ color: 'var(--accent)', fontWeight: 700 }}>Total Bayar</TableCell>
          <TableCell sx={{ color: 'var(--muted)', fontWeight: 700 }}>Status Bayar</TableCell>
          <TableCell sx={{ color: 'var(--accent-2)', fontWeight: 700 }}>Jatuh Tempo</TableCell>
          <TableCell sx={{ color: 'var(--accent-2)', fontWeight: 700 }}>Status Order</TableCell>
          <TableCell sx={{ color: 'var(--accent-2)', fontWeight: 700 }}>Status</TableCell>
